...
**DataJS**, a much narrower interchange format: JSON extended from a tree to a
DAG and nothing else, with `;`-terminated statements, no `import`, no comments,
no identifier keys and no trailing commas. The data subset described in *this*
