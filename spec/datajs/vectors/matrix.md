...
| `array/elements/negative-first` | `array-elements-negative-first` | not applicable, [note 43](#notes) | not applicable, [note 79](#notes) |
...
| `array/empty` | `array-empty` | `ser-array-empty` | not applicable, [note 96](#notes) |
| `array/nested/array` | `array-nested-array` | `ser-array-nested-array` | not applicable, [note 68](#notes) |
| `array/nested/deep` | `array-nested-deep` | not applicable, [note 39](#notes) | not applicable, [note 68](#notes) |
| `array/nested/empty` | `array-nested-empty` | not applicable, [note 41](#notes) | not applicable, [note 68](#notes) |
| `array/nested/object` | `array-nested-object` | `ser-array-nested-object` | not applicable, [note 68](#notes) |
| `array/no-comma` | `array-no-comma` | not applicable, [note 1](#notes) | not applicable, [note 59](#notes) |
| `array/object/nested/mixed` | `mixed-nested` | not applicable, [note 38](#notes) | not applicable, [note 101](#notes) |
| `array/one` | `array-one` | `ser-array-one` | not applicable, [note 90](#notes) |
...
| `array/three` | `array-three` | `ser-array-three` | not applicable, [note 97](#notes) |
...
| `array/two` | `array-two` | not applicable, [note 36](#notes) | not applicable, [note 91](#notes) |
...
| `bigint/digit9` | `bigint-9` | not applicable, [note 16](#notes) | not applicable, [note 78](#notes) |
| `bigint/digit9/neg` | `bigint-neg-9` | not applicable, [note 16](#notes) | not applicable, [note 78](#notes) |
...
| `bigint/zero/neg` | `bigint-neg-0` | not applicable, [note 17](#notes) | not applicable, [note 103](#notes) |
| `byte/bom/first` | `byte-bom-first` | not applicable, [note 113](#notes) | not applicable, [note 114](#notes) |
| `byte/truncated` | `byte-truncated` | not applicable, [note 113](#notes) | not applicable, [note 114](#notes) |
| `byte/valid/widths` | `byte-valid-widths` | not applicable, [note 113](#notes) | not applicable, [note 114](#notes) |
...
| `const/one` | `const-one` | not applicable, [note 28](#notes) | not applicable, [note 92](#notes) |
| `const/reference/chain` | `const-reference-chain` | not applicable, [note 27](#notes) | not applicable, [note 70](#notes) |
| `const/reference/chain/shared` | `const-reference-chain-shared` | not applicable, [note 27](#notes) | not applicable, [note 70](#notes) |
| `const/reference/element` | `const-reference-element` | not applicable, [note 27](#notes) | not applicable, [note 70](#notes) |
| `const/reference/member` | `const-reference-member` | not applicable, [note 27](#notes) | not applicable, [note 70](#notes) |
...
| `const/shared/nested` | `const-shared-nested` | not applicable, [note 34](#notes) | not applicable, [note 106](#notes) |
| `const/shared/object` | `const-shared-object` | `ser-sharing-object`, `graph-sharing-object` | `norm-shared-object` |
| `const/shared/three-paths` | `const-shared-three-paths` | not applicable, [note 35](#notes) | not applicable, [note 109](#notes) |
...
| `const/two` | `const-two` | not applicable, [note 29](#notes) | not applicable, [note 93](#notes) |
| `const/unreferenced` | `const-unreferenced` | not applicable, [note 31](#notes) | not applicable, [note 85](#notes) |
| `const/unreferenced/among` | `const-unreferenced-among` | not applicable, [note 31](#notes) | not applicable, [note 85](#notes) |
| `const/unshared/twins` | `const-unshared-twins` | not applicable, [note 32](#notes) | not applicable, [note 102](#notes) |
| `const/value/every-alternative` | `const-value-every` | not applicable, [note 30](#notes) | not applicable, [note 98](#notes) |
| `document/both-edges` | `document-both-edges` | not applicable, [note 5](#notes) | not applicable, [note 107](#notes) |
...
| `document/consts/chain` | `document-const-chain-long` | not applicable, [note 5](#notes) | not applicable, [note 82](#notes) |
| `document/consts/many` | `document-many-consts` | not applicable, [note 5](#notes) | not applicable, [note 82](#notes) |
...
| `document/leading/lf` | `document-leading-lf` | not applicable, [note 5](#notes) | not applicable, [note 83](#notes) |
| `document/leading/run` | `document-leading-run` | not applicable, [note 5](#notes) | not applicable, [note 83](#notes) |
...
| `document/shortest` | `document-shortest` | not applicable, [note 5](#notes) | not applicable, [note 104](#notes) |
| `document/spelling/one-line` | `document-spelling-one-line` | not applicable, [note 5](#notes) | `norm-document-spelling-one-line` |
| `document/spelling/readable` | `document-spelling-readable` | not applicable, [note 5](#notes) | not applicable, [note 110](#notes) |
...
| `document/trailing/crlf` | `document-trailing-crlf` | not applicable, [note 5](#notes) | not applicable, [note 71](#notes) |
| `document/trailing/lf` | `document-trailing-lf` | not applicable, [note 5](#notes) | not applicable, [note 71](#notes) |
| `document/trailing/reference` | `document-trailing-reference` | not applicable, [note 5](#notes) | not applicable, [note 71](#notes) |
| `document/trailing/run` | `document-trailing-run` | not applicable, [note 5](#notes) | not applicable, [note 71](#notes) |
| `document/trailing/spaces` | `document-trailing-spaces` | not applicable, [note 5](#notes) | not applicable, [note 71](#notes) |
| `document/trailing/value` | `document-trailing-value` | not applicable, [note 5](#notes) | not applicable, [note 71](#notes) |
...
| `key/proto/value/null` | `key-proto-value-null` | not applicable, [note 56](#notes) | not applicable, [note 77](#notes) |
| `key/proto/value/object` | `key-proto-value-object` | not applicable, [note 56](#notes) | not applicable, [note 77](#notes) |
| `key/proto/value/shared` | `key-proto-shared` | not applicable, [note 56](#notes) | not applicable, [note 77](#notes) |
...
| `key/string/escape/slash` | `key-escape-slash` | not applicable, [note 21](#notes) | not applicable, [note 108](#notes) |
...
| `key/string/escape/u/09af` | `key-escape-u-09af` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/9afA` | `key-escape-u-9afA` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/AF09` | `key-escape-u-AF09` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/F09a` | `key-escape-u-F09a` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/afAF` | `key-escape-u-afAF` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/fAF0` | `key-escape-u-fAF0` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/002f/0` | `key-escape-u-non-hex-002f-0` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/002f/1` | `key-escape-u-non-hex-002f-1` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/002f/2` | `key-escape-u-non-hex-002f-2` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/002f/3` | `key-escape-u-non-hex-002f-3` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/003a/0` | `key-escape-u-non-hex-003a-0` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/003a/1` | `key-escape-u-non-hex-003a-1` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/003a/2` | `key-escape-u-non-hex-003a-2` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/003a/3` | `key-escape-u-non-hex-003a-3` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0040/0` | `key-escape-u-non-hex-0040-0` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0040/1` | `key-escape-u-non-hex-0040-1` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0040/2` | `key-escape-u-non-hex-0040-2` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0040/3` | `key-escape-u-non-hex-0040-3` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0047/0` | `key-escape-u-non-hex-0047-0` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0047/1` | `key-escape-u-non-hex-0047-1` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0047/2` | `key-escape-u-non-hex-0047-2` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0047/3` | `key-escape-u-non-hex-0047-3` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0060/0` | `key-escape-u-non-hex-0060-0` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0060/1` | `key-escape-u-non-hex-0060-1` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0060/2` | `key-escape-u-non-hex-0060-2` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0060/3` | `key-escape-u-non-hex-0060-3` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0067/0` | `key-escape-u-non-hex-0067-0` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0067/1` | `key-escape-u-non-hex-0067-1` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0067/2` | `key-escape-u-non-hex-0067-2` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/non-hex/0067/3` | `key-escape-u-non-hex-0067-3` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/short/0` | `key-escape-u-short-0` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
| `key/string/escape/u/short/3` | `key-escape-u-short-3` | not applicable, [note 19](#notes) | not applicable, [note 65](#notes) |
...
| `key/string/surrogate/lone/raw/d800` | `key-surrogate-lone-raw-d800` | not applicable, [note 45](#notes) | not applicable, [note 76](#notes) |
| `key/string/surrogate/lone/raw/dbff` | `key-surrogate-lone-raw-dbff` | not applicable, [note 45](#notes) | not applicable, [note 76](#notes) |
| `key/string/surrogate/lone/raw/dc00` | `key-surrogate-lone-raw-dc00` | not applicable, [note 45](#notes) | not applicable, [note 76](#notes) |
| `key/string/surrogate/lone/raw/dfff` | `key-surrogate-lone-raw-dfff` | not applicable, [note 45](#notes) | not applicable, [note 76](#notes) |
| `key/string/surrogate/pair/high-corner` | `key-surrogate-pair-high-corner` | not applicable, [note 51](#notes) | not applicable, [note 75](#notes) |
| `key/string/surrogate/pair/interior` | `key-surrogate-pair-interior` | `ser-key-surrogate-pair-interior` | not applicable, [note 75](#notes) |
| `key/string/surrogate/pair/low-corner` | `key-surrogate-pair-low-corner` | not applicable, [note 50](#notes) | not applicable, [note 75](#notes) |
| `key/string/surrogate/pair/mixed` | `key-surrogate-pair-mixed` | not applicable, [note 49](#notes) | not applicable, [note 75](#notes) |
| `leaf/boolean/false` | `false` | `ser-false` | not applicable, [note 66](#notes) |
| `leaf/boolean/true` | `true` | `ser-true` | not applicable, [note 66](#notes) |
| `leaf/nan` | `nan` | `ser-nan` | not applicable, [note 66](#notes) |
| `leaf/null` | `null` | `ser-null` | not applicable, [note 66](#notes) |
| `leaf/undefined` | `undefined` | `ser-undefined` | not applicable, [note 66](#notes) |
...
| `number/binary64/overflow` | `number-overflow` | not applicable, [note 14](#notes) | not applicable, [note 88](#notes) |
| `number/binary64/overflow/neg` | `number-neg-overflow` | not applicable, [note 14](#notes) | not applicable, [note 88](#notes) |
| `number/binary64/rounding` | `number-rounding` | not applicable, [note 13](#notes) | not applicable, [note 87](#notes) |
| `number/binary64/rounding/neg` | `number-neg-rounding` | not applicable, [note 13](#notes) | not applicable, [note 87](#notes) |
...
| `number/binary64/underflow` | `number-underflow` | not applicable, [note 15](#notes) | not applicable, [note 89](#notes) |
| `number/binary64/underflow/neg` | `number-neg-underflow` | not applicable, [note 15](#notes) | not applicable, [note 89](#notes) |
...
| `number/exp/E` | `number-1E2` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/E/neg` | `number-neg-1E2` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/double-sign` | `number-exp-double-sign` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/double-sign/neg` | `number-neg-exp-double-sign` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/e` | `number-1e09` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/e/neg` | `number-neg-1e09` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/high-first` | `number-1e90` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/high-first/neg` | `number-neg-1e90` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/infinity` | `number-exp-word` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/infinity/neg` | `number-neg-exp-word` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/minus` | `number-1e-2` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/minus/neg` | `number-neg-1e-2` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/no-digits` | `number-exp-no-digits` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/no-digits/neg` | `number-neg-exp-no-digits` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/one-digit/high` | `number-1e9` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/one-digit/high/neg` | `number-neg-1e9` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/one-digit/low` | `number-1e0` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/one-digit/low/neg` | `number-neg-1e0` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/plus` | `number-1e+2` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/plus/neg` | `number-neg-1e+2` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/point` | `number-exp-point` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/point/neg` | `number-neg-exp-point` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/sign/no-digits` | `number-exp-sign-no-digits` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/exp/sign/no-digits/neg` | `number-neg-exp-sign-no-digits` | not applicable, [note 6](#notes) | not applicable, [note 62](#notes) |
| `number/frac` | `number-1.09` | `ser-number-1.5` | `norm-number-1.5` |
| `number/frac-exp` | `number-1.09e-2` | not applicable, [note 10](#notes) | not applicable, [note 80](#notes) |
| `number/frac-exp/neg` | `number-neg-1.09e-2` | not applicable, [note 10](#notes) | not applicable, [note 80](#notes) |
| `number/frac/high-first` | `number-1.90` | not applicable, [note 9](#notes) | not applicable, [note 86](#notes) |
| `number/frac/high-first/neg` | `number-neg-1.90` | not applicable, [note 9](#notes) | not applicable, [note 86](#notes) |
...
| `number/frac/one-digit` | `number-1.0` | not applicable, [note 8](#notes) | not applicable, [note 72](#notes) |
| `number/frac/one-digit/high` | `number-1.9` | not applicable, [note 8](#notes) | not applicable, [note 72](#notes) |
| `number/frac/one-digit/high/neg` | `number-neg-1.9` | not applicable, [note 8](#notes) | not applicable, [note 72](#notes) |
| `number/frac/one-digit/neg` | `number-neg-1.0` | not applicable, [note 8](#notes) | not applicable, [note 72](#notes) |
...
| `number/int/digit9` | `number-9` | not applicable, [note 11](#notes) | not applicable, [note 84](#notes) |
| `number/int/digit9/neg` | `number-neg-9` | not applicable, [note 11](#notes) | not applicable, [note 84](#notes) |
...
| `number/zero/exp` | `number-0e0` | not applicable, [note 7](#notes) | not applicable, [note 67](#notes) |
| `number/zero/exp/neg` | `number-neg-0e0` | not applicable, [note 7](#notes) | not applicable, [note 67](#notes) |
| `number/zero/frac` | `number-0.0` | not applicable, [note 7](#notes) | not applicable, [note 67](#notes) |
| `number/zero/frac/neg` | `number-neg-0.0` | not applicable, [note 7](#notes) | not applicable, [note 67](#notes) |
| `object/double-comma` | `object-double-comma` | not applicable, [note 1](#notes) | not applicable, [note 59](#notes) |
| `object/duplicate/adjacent` | `object-duplicate-first` | not applicable, [note 22](#notes) | not applicable, [note 63](#notes) |
| `object/duplicate/both-levels` | `object-duplicate-both-levels` | not applicable, [note 22](#notes) | not applicable, [note 63](#notes) |
| `object/duplicate/escaped` | `object-duplicate-escaped` | not applicable, [note 22](#notes) | not applicable, [note 63](#notes) |
| `object/duplicate/escaped-first` | `object-duplicate-escaped-first` | not applicable, [note 22](#notes) | not applicable, [note 63](#notes) |
| `object/duplicate/index` | `object-duplicate-index` | not applicable, [note 22](#notes) | not applicable, [note 63](#notes) |
| `object/duplicate/nested` | `object-duplicate-nested` | not applicable, [note 22](#notes) | not applicable, [note 63](#notes) |
| `object/duplicate/plain` | `object-duplicate-plain` | not applicable, [note 22](#notes) | not applicable, [note 63](#notes) |
| `object/duplicate/proto` | `object-duplicate-proto` | not applicable, [note 22](#notes) | not applicable, [note 63](#notes) |
| `object/duplicate/three` | `object-duplicate-three` | not applicable, [note 22](#notes) | not applicable, [note 63](#notes) |
| `object/empty` | `object-empty` | `ser-object-empty` | not applicable, [note 99](#notes) |
...
| `object/key-order/escaped-index` | `object-key-order-escaped-index` | not applicable, [note 26](#notes) | not applicable, [note 112](#notes) |
...
| `object/key-order/index-first` | `object-key-order-index-first` | not applicable, [note 25](#notes) | not applicable, [note 111](#notes) |
...
| `object/nested/array` | `object-nested-array` | `ser-object-nested-array` | not applicable, [note 69](#notes) |
| `object/nested/deep` | `object-nested-deep` | not applicable, [note 40](#notes) | not applicable, [note 69](#notes) |
| `object/nested/empty` | `object-nested-empty` | not applicable, [note 42](#notes) | not applicable, [note 69](#notes) |
| `object/nested/object` | `object-nested-object` | `ser-object-nested-object` | not applicable, [note 69](#notes) |
...
| `object/one` | `object-one` | `ser-object-one` | not applicable, [note 94](#notes) |
| `object/spread` | `object-spread` | not applicable, [note 1](#notes) | not applicable, [note 59](#notes) |
| `object/three` | `object-three` | `ser-object-three` | not applicable, [note 100](#notes) |
...
| `object/two` | `object-two` | not applicable, [note 37](#notes) | not applicable, [note 95](#notes) |
| `object/unclosed` | `object-unclosed` | not applicable, [note 1](#notes) | not applicable, [note 59](#notes) |
| `object/unshared` | `object-unshared` | `graph-unshared-object-empty` | not applicable, [note 81](#notes) |
...
| `string/escape/slash` | `string-escape-slash` | not applicable, [note 20](#notes) | not applicable, [note 105](#notes) |
...
| `string/escape/u/09af` | `string-escape-u-09af` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/9afA` | `string-escape-u-9afA` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/AF09` | `string-escape-u-AF09` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/F09a` | `string-escape-u-F09a` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/afAF` | `string-escape-u-afAF` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/fAF0` | `string-escape-u-fAF0` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/002f/0` | `string-escape-u-non-hex-002f-0` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/002f/1` | `string-escape-u-non-hex-002f-1` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/002f/2` | `string-escape-u-non-hex-002f-2` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/002f/3` | `string-escape-u-non-hex-002f-3` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/003a/0` | `string-escape-u-non-hex-003a-0` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/003a/1` | `string-escape-u-non-hex-003a-1` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/003a/2` | `string-escape-u-non-hex-003a-2` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/003a/3` | `string-escape-u-non-hex-003a-3` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0040/0` | `string-escape-u-non-hex-0040-0` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0040/1` | `string-escape-u-non-hex-0040-1` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0040/2` | `string-escape-u-non-hex-0040-2` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0040/3` | `string-escape-u-non-hex-0040-3` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0047/0` | `string-escape-u-non-hex-0047-0` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0047/1` | `string-escape-u-non-hex-0047-1` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0047/2` | `string-escape-u-non-hex-0047-2` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0047/3` | `string-escape-u-non-hex-0047-3` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0060/0` | `string-escape-u-non-hex-0060-0` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0060/1` | `string-escape-u-non-hex-0060-1` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0060/2` | `string-escape-u-non-hex-0060-2` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0060/3` | `string-escape-u-non-hex-0060-3` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0067/0` | `string-escape-u-non-hex-0067-0` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0067/1` | `string-escape-u-non-hex-0067-1` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0067/2` | `string-escape-u-non-hex-0067-2` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/non-hex/0067/3` | `string-escape-u-non-hex-0067-3` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/short/0` | `string-escape-u-short-0` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
| `string/escape/u/short/3` | `string-escape-u-short-3` | not applicable, [note 18](#notes) | not applicable, [note 64](#notes) |
...
| `string/surrogate/lone/raw/d800` | `string-surrogate-lone-raw-d800` | not applicable, [note 44](#notes) | not applicable, [note 74](#notes) |
| `string/surrogate/lone/raw/dbff` | `string-surrogate-lone-raw-dbff` | not applicable, [note 44](#notes) | not applicable, [note 74](#notes) |
| `string/surrogate/lone/raw/dc00` | `string-surrogate-lone-raw-dc00` | not applicable, [note 44](#notes) | not applicable, [note 74](#notes) |
| `string/surrogate/lone/raw/dfff` | `string-surrogate-lone-raw-dfff` | not applicable, [note 44](#notes) | not applicable, [note 74](#notes) |
| `string/surrogate/pair/high-corner` | `string-surrogate-pair-high-corner` | not applicable, [note 48](#notes) | not applicable, [note 73](#notes) |
| `string/surrogate/pair/interior` | `string-surrogate-pair-interior` | `ser-string-surrogate-pair-interior` | not applicable, [note 73](#notes) |
| `string/surrogate/pair/low-corner` | `string-surrogate-pair-low-corner` | not applicable, [note 47](#notes) | not applicable, [note 73](#notes) |
| `string/surrogate/pair/mixed` | `string-surrogate-pair-mixed` | not applicable, [note 46](#notes) | not applicable, [note 73](#notes) |
...
62. **`normalize`**, subtree `number/exp` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
63. **`normalize`**, subtree `object/duplicate` — this is a fact about a document a reader takes, and normalized form is handed a graph, so the class has no normalized output of its own
64. **`normalize`**, subtree `string/escape/u` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
65. **`normalize`**, subtree `key/string/escape/u` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
66. **`normalize`**, subtree `leaf` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
67. **`normalize`**, subtree `number/zero` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
68. **`normalize`**, subtree `array/nested` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
69. **`normalize`**, subtree `object/nested` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
70. **`normalize`**, subtree `const/reference` — this is a fact about a document a reader takes, and normalized form is handed a graph, so the class has no normalized output of its own
71. **`normalize`**, subtree `document/trailing` — this is a fact about a document a reader takes, and normalized form is handed a graph, so the class has no normalized output of its own
72. **`normalize`**, subtree `number/frac/one-digit` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
73. **`normalize`**, subtree `string/surrogate/pair` — the four lone surrogates and the pair are pinned, and the escaping rule is per code unit, so an adjacency's spelling follows from theirs with nothing left to decide
74. **`normalize`**, subtree `string/surrogate/lone/raw` — the four lone surrogates and the pair are pinned, and the escaping rule is per code unit, so an adjacency's spelling follows from theirs with nothing left to decide
75. **`normalize`**, subtree `key/string/surrogate/pair` — the four lone surrogates and the pair are pinned, and the escaping rule is per code unit, so an adjacency's spelling follows from theirs with nothing left to decide
76. **`normalize`**, subtree `key/string/surrogate/lone/raw` — the four lone surrogates and the pair are pinned, and the escaping rule is per code unit, so an adjacency's spelling follows from theirs with nothing left to decide
77. **`normalize`**, subtree `key/proto/value` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
78. **`normalize`**, subtree `bigint/digit9` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
79. **`normalize`**, class `array/elements/negative-first` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
80. **`normalize`**, subtree `number/frac-exp` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
81. **`normalize`**, class `object/unshared` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
82. **`normalize`**, subtree `document/consts` — this is a fact about a document a reader takes, and normalized form is handed a graph, so the class has no normalized output of its own
83. **`normalize`**, subtree `document/leading` — this is a fact about a document a reader takes, and normalized form is handed a graph, so the class has no normalized output of its own
84. **`normalize`**, subtree `number/int/digit9` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
85. **`normalize`**, subtree `const/unreferenced` — this is a fact about a document a reader takes, and normalized form is handed a graph, so the class has no normalized output of its own
86. **`normalize`**, subtree `number/frac/high-first` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
87. **`normalize`**, subtree `number/binary64/rounding` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
88. **`normalize`**, subtree `number/binary64/overflow` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
89. **`normalize`**, subtree `number/binary64/underflow` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
90. **`normalize`**, subtree `array/one` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
91. **`normalize`**, subtree `array/two` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
92. **`normalize`**, subtree `const/one` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
93. **`normalize`**, subtree `const/two` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
94. **`normalize`**, subtree `object/one` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
95. **`normalize`**, subtree `object/two` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
96. **`normalize`**, subtree `array/empty` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
97. **`normalize`**, subtree `array/three` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
98. **`normalize`**, subtree `const/value` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
99. **`normalize`**, subtree `object/empty` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
100. **`normalize`**, subtree `object/three` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
101. **`normalize`**, subtree `array/object` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
102. **`normalize`**, subtree `const/unshared` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
103. **`normalize`**, subtree `bigint/zero/neg` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
104. **`normalize`**, subtree `document/shortest` — this is a fact about a document a reader takes, and normalized form is handed a graph, so the class has no normalized output of its own
105. **`normalize`**, subtree `string/escape/slash` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
106. **`normalize`**, subtree `const/shared/nested` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
107. **`normalize`**, subtree `document/both-edges` — this is a fact about a document a reader takes, and normalized form is handed a graph, so the class has no normalized output of its own
108. **`normalize`**, subtree `key/string/escape/slash` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
109. **`normalize`**, subtree `const/shared/three-paths` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
110. **`normalize`**, subtree `document/spelling/readable` — this is a fact about a document a reader takes, and normalized form is handed a graph, so the class has no normalized output of its own
111. **`normalize`**, subtree `object/key-order/index-first` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
112. **`normalize`**, subtree `object/key-order/escaped-index` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
113. **`serializer`**, subtree `byte` — a byte document is a reader's input; a serializer is handed a graph and emits a document as text, so encoding it is the caller's
114. **`normalize`**, subtree `byte` — a byte document is a reader's input; normalized form is handed a graph and produces text, so encoding it is the caller's
