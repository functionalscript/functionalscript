...
| - | - | -: | -: | -: |
<<<<<<< HEAD
| `reader` | `accept`, `reject` | 673 | 50 | 0 |
| `serializer` | `serializer-accept`, `graph-equivalence` | 123 | 600 | 0 |
| `normalize` | `normalize` | 130 | 593 | 0 |
...
| `bigint/binary/neg` | `bigint-neg-binary` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/digit9` | `bigint-9` | not applicable, [note 16](#notes) | not applicable, [note 91](#notes) |
| `bigint/digit9/neg` | `bigint-neg-9` | not applicable, [note 16](#notes) | not applicable, [note 91](#notes) |
...
| `bigint/exponent` | `bigint-exponent` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/exponent-upper` | `bigint-exponent-upper` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/exponent-upper/neg` | `bigint-neg-exponent-upper` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/exponent/neg` | `bigint-neg-exponent` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/fraction` | `bigint-fraction` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/fraction/neg` | `bigint-neg-fraction` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/hex` | `bigint-hex` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/hex-upper` | `bigint-hex-upper` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/hex-upper/neg` | `bigint-neg-hex-upper` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/hex/neg` | `bigint-neg-hex` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/leading-point` | `bigint-leading-point` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/leading-point/neg` | `bigint-neg-leading-point` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/leading-zero` | `bigint-leading-zero` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/leading-zero/neg` | `bigint-neg-leading-zero` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/octal` | `bigint-octal` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
...
| `bigint/suffix/double` | `bigint-suffix-double` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/suffix/double/neg` | `bigint-neg-suffix-double` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/suffix/space` | `bigint-suffix-space` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/suffix/space/neg` | `bigint-neg-suffix-space` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/suffix/upper` | `bigint-suffix-upper` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `bigint/suffix/upper/neg` | `bigint-neg-suffix-upper` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
...
| `byte/bom/first` | `byte-bom-first` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `byte/truncated` | `byte-truncated` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
...
| `const/duplicate` | `const-duplicate` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `const/duplicate/same-value` | `const-duplicate-same-value` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `const/hoist/occurrences` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-hoist-occurrences` |
| `const/hoist/only-if/array` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-hoist-only-if-array` |
| `const/hoist/only-if/object` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-hoist-only-if-object` |
| `const/name/counter/two-digits` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-name-counter-two-digits` |
| `const/name/dollar-inside` | `const-name-dollar-inside` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `const/name/no-dollar` | `const-name-no-dollar` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `const/name/post-order/array/array` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-name-post-order-array-array` |
| `const/name/post-order/array/object` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-name-post-order-array-object` |
| `const/name/post-order/object/array` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-name-post-order-object-array` |
| `const/name/post-order/object/object` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-name-post-order-object-object` |
| `const/name/reserved` | `const-name-reserved` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
...
| `document/consts/chain` | `document-const-chain-long` | not applicable, [note 5](#notes) | not applicable, [note 95](#notes) |
| `document/consts/many` | `document-many-consts` | not applicable, [note 5](#notes) | not applicable, [note 95](#notes) |
| `document/empty` | `document-empty` | not applicable, [note 5](#notes) | not applicable, [note 67](#notes) |
| `document/empty-statement/between` | `document-semicolon-between` | not applicable, [note 5](#notes) | not applicable, [note 67](#notes) |
| `document/empty-statement/double` | `document-semicolon-double` | not applicable, [note 5](#notes) | not applicable, [note 67](#notes) |
| `document/empty-statement/leading` | `document-semicolon-leading` | not applicable, [note 5](#notes) | not applicable, [note 67](#notes) |
| `document/export/missing` | `document-no-export` | not applicable, [note 5](#notes) | not applicable, [note 67](#notes) |
| `document/export/not-last` | `document-export-not-last` | not applicable, [note 5](#notes) | not applicable, [note 67](#notes) |
...
| `document/statement/var` | `document-statement-var` | not applicable, [note 5](#notes) | not applicable, [note 67](#notes) |
| `document/trailing/crlf` | `document-trailing-crlf` | not applicable, [note 5](#notes) | not applicable, [note 84](#notes) |
| `document/trailing/lf` | `document-trailing-lf` | not applicable, [note 5](#notes) | not applicable, [note 84](#notes) |
| `document/trailing/reference` | `document-trailing-reference` | not applicable, [note 5](#notes) | not applicable, [note 84](#notes) |
| `document/trailing/run` | `document-trailing-run` | not applicable, [note 5](#notes) | not applicable, [note 84](#notes) |
| `document/trailing/spaces` | `document-trailing-spaces` | not applicable, [note 5](#notes) | not applicable, [note 84](#notes) |
| `document/trailing/value` | `document-trailing-value` | not applicable, [note 5](#notes) | not applicable, [note 84](#notes) |
| `document/whitespace-only` | `document-whitespace-only` | not applicable, [note 5](#notes) | not applicable, [note 67](#notes) |
| `export/form/const` | `export-const` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `export/form/named` | `export-named` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `export/form/no-default` | `export-no-default` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `export/form/no-value` | `export-default-only` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `id/distinct/case` | `id-distinct-case` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/distinct/dollar` | `id-distinct-dollar` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/distinct/length` | `id-distinct-length` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/distinct/prefix` | `id-distinct-prefix` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/escaped/both` | `id-escaped-both` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/escaped/braces` | `id-escaped-braces` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/escaped/declaration` | `id-escaped-declaration` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/escaped/reference` | `id-escaped-reference` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/escaped/tail` | `id-escaped-tail` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/non-ascii` | `id-non-ascii` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/non-ascii/cjk` | `id-non-ascii-cjk` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/non-ascii/zwj` | `id-non-ascii-zwj` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/contextual/as` | `id-tail-contextual-as` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/contextual/async` | `id-tail-contextual-async` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/contextual/from` | `id-tail-contextual-from` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/contextual/get` | `id-tail-contextual-get` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/contextual/of` | `id-tail-contextual-of` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/contextual/set` | `id-tail-contextual-set` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/digit-first` | `id-tail-digit-first` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/dollar` | `id-tail-dollar` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/empty` | `id-empty-tail` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/endpoints` | `id-tail-endpoints` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/hash` | `id-tail-hash` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/hyphen` | `id-tail-hyphen` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/keyword/const` | `id-tail-keyword-const` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/keyword/default` | `id-tail-keyword-default` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/keyword/export` | `id-tail-keyword-export` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/long` | `id-tail-long` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/one/9` | `id-tail-one-9` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/one/A` | `id-tail-one-A` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/one/Z` | `id-tail-one-Z` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/one/a` | `id-tail-one-a` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/one/underscore` | `id-tail-one-underscore` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/one/z` | `id-tail-one-z` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/arguments` | `id-tail-reserved-arguments` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/await` | `id-tail-reserved-await` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/class` | `id-tail-reserved-class` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/delete` | `id-tail-reserved-delete` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/enum` | `id-tail-reserved-enum` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/eval` | `id-tail-reserved-eval` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/function` | `id-tail-reserved-function` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/if` | `id-tail-reserved-if` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/import` | `id-tail-reserved-import` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/in` | `id-tail-reserved-in` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/let` | `id-tail-reserved-let` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/new` | `id-tail-reserved-new` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/static` | `id-tail-reserved-static` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/this` | `id-tail-reserved-this` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/typeof` | `id-tail-reserved-typeof` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/var` | `id-tail-reserved-var` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/with` | `id-tail-reserved-with` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/reserved/yield` | `id-tail-reserved-yield` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/value-word/Infinity` | `id-tail-value-word-Infinity` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/value-word/NaN` | `id-tail-value-word-NaN` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/value-word/false` | `id-tail-value-word-false` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/value-word/null` | `id-tail-value-word-null` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/value-word/true` | `id-tail-value-word-true` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `id/tail/value-word/undefined` | `id-tail-value-word-undefined` | not applicable, [note 2](#notes) | not applicable, [note 68](#notes) |
| `infinity/minus` | `neg-infinity` | `ser-neg-infinity` | `norm-neg-infinity` |
| `infinity/plus` | `infinity` | `ser-infinity` | `norm-infinity` |
| `key/computed/number` | `key-computed-number` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/computed/reference` | `key-computed-reference` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/computed/string` | `key-computed-string` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/identifier` | `key-identifier` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/identifier/dollar` | `key-identifier-dollar` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/numeric` | `key-numeric` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/numeric/float` | `key-numeric-float` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/proto` | `key-proto` | `ser-key-proto` | `norm-key-proto` |
| `key/proto/among` | `key-proto-among` | `ser-key-proto-among` | `norm-key-proto-among` |
| `key/proto/bare` | `key-proto-bare` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/proto/computed/bare` | `key-proto-computed-bare` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/proto/computed/escaped` | `key-proto-computed-escaped` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/proto/computed/single-quoted` | `key-proto-computed-single-quoted` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/proto/computed/space/both` | `key-proto-computed-space-both` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
...
| `key/proto/string/escaped-all` | `key-proto-string-escaped-all` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/proto/string/nested` | `key-proto-string-nested` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/proto/value/null` | `key-proto-value-null` | not applicable, [note 63](#notes) | not applicable, [note 90](#notes) |
| `key/proto/value/object` | `key-proto-value-object` | not applicable, [note 63](#notes) | not applicable, [note 90](#notes) |
| `key/proto/value/shared` | `key-proto-shared` | not applicable, [note 63](#notes) | not applicable, [note 90](#notes) |
| `key/string/continuation` | `key-continuation` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/continuation/crlf` | `key-continuation-crlf` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/empty` | `key-empty` | `ser-key-empty` | `norm-key-empty` |
| `key/string/escape/0` | `key-escape-0` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
...
| `key/string/escape/backtick` | `key-escape-backtick` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/escape/f` | `key-escape-f` | `ser-key-escape-f` | `norm-key-escape-f` |
| `key/string/escape/identity` | `key-escape-identity` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/escape/identity/a` | `key-escape-identity-a` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/escape/n` | `key-escape-n` | `ser-key-escape-n` | `norm-key-escape-n` |
| `key/string/escape/octal` | `key-escape-octal` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/escape/octal/8` | `key-escape-octal-8` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
...
| `key/string/escape/u/09af` | `key-escape-u-09af` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/9afA` | `key-escape-u-9afA` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/AF09` | `key-escape-u-AF09` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/F09a` | `key-escape-u-F09a` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/afAF` | `key-escape-u-afAF` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/fAF0` | `key-escape-u-fAF0` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/002f/0` | `key-escape-u-non-hex-002f-0` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/002f/1` | `key-escape-u-non-hex-002f-1` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/002f/2` | `key-escape-u-non-hex-002f-2` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/002f/3` | `key-escape-u-non-hex-002f-3` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/003a/0` | `key-escape-u-non-hex-003a-0` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/003a/1` | `key-escape-u-non-hex-003a-1` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/003a/2` | `key-escape-u-non-hex-003a-2` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/003a/3` | `key-escape-u-non-hex-003a-3` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0040/0` | `key-escape-u-non-hex-0040-0` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0040/1` | `key-escape-u-non-hex-0040-1` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0040/2` | `key-escape-u-non-hex-0040-2` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0040/3` | `key-escape-u-non-hex-0040-3` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0047/0` | `key-escape-u-non-hex-0047-0` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0047/1` | `key-escape-u-non-hex-0047-1` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0047/2` | `key-escape-u-non-hex-0047-2` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0047/3` | `key-escape-u-non-hex-0047-3` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0060/0` | `key-escape-u-non-hex-0060-0` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0060/1` | `key-escape-u-non-hex-0060-1` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0060/2` | `key-escape-u-non-hex-0060-2` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0060/3` | `key-escape-u-non-hex-0060-3` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0067/0` | `key-escape-u-non-hex-0067-0` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0067/1` | `key-escape-u-non-hex-0067-1` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0067/2` | `key-escape-u-non-hex-0067-2` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/non-hex/0067/3` | `key-escape-u-non-hex-0067-3` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/short/0` | `key-escape-u-short-0` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u/short/3` | `key-escape-u-short-3` | not applicable, [note 19](#notes) | not applicable, [note 78](#notes) |
| `key/string/escape/u00/0000` | `key-escape-u00-0000` | `ser-key-escape-u00-0000` | `norm-key-escape-u00-0000` |
| `key/string/escape/u00/0007` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-key-escape-u00-0007` |
| `key/string/escape/u00/000b` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-key-escape-u00-000b` |
| `key/string/escape/u00/000e` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-key-escape-u00-000e` |
| `key/string/escape/u00/000f` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-key-escape-u00-000f` |
| `key/string/escape/u00/0010` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-key-escape-u00-0010` |
| `key/string/escape/u00/0019` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-key-escape-u00-0019` |
| `key/string/escape/u00/001a` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-key-escape-u00-001a` |
| `key/string/escape/u00/001f` | `key-escape-u00-001f` | `ser-key-escape-u00-001f` | `norm-key-escape-u00-001f` |
| `key/string/escape/uppercase` | `key-escape-uppercase-n` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/escape/uppercase/u` | `key-escape-uppercase-u` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/escape/v` | `key-escape-v` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/escape/x` | `key-escape-x` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/mixed` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-key-mixed` |
| `key/string/quote/single` | `key-quote-single` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/quote/template` | `key-quote-template` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/quote/template/empty` | `key-quote-template-empty` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/raw-control/0000` | `key-raw-0000` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/raw-control/0009` | `key-raw-0009` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/raw-control/000a` | `key-raw-000a` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `key/string/raw-control/000d` | `key-raw-000d` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
...
| `key/string/raw/range/0023-005b/high` | `key-raw-005b` | not applicable, [note 58](#notes) | `norm-key-raw-005b` |
| `key/string/raw/range/0023-005b/low` | `key-raw-0023` | not applicable, [note 58](#notes) | `norm-key-raw-0023` |
| `key/string/raw/range/005d-10ffff/high` | `key-raw-10ffff` | `ser-key-raw-10ffff` | `norm-key-raw-10ffff` |
| `key/string/raw/range/005d-10ffff/low` | `key-raw-005d` | not applicable, [note 62](#notes) | `norm-key-raw-005d` |
| `key/string/raw/slash` | `key-raw-slash` | not applicable, [note 23](#notes) | `norm-key-raw-slash` |
| `key/string/raw/surrogate-hole/d7ff` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-key-raw-d7ff` |
| `key/string/raw/surrogate-hole/e000` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-key-raw-e000` |
| `key/string/raw/ws-like/00a0` | `key-raw-ws-like-00a0` | `ser-key-raw-ws-like-00a0` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/1680` | `key-raw-ws-like-1680` | `ser-key-raw-ws-like-1680` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/2000` | `key-raw-ws-like-2000` | `ser-key-raw-ws-like-2000` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/2001` | `key-raw-ws-like-2001` | `ser-key-raw-ws-like-2001` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/2002` | `key-raw-ws-like-2002` | `ser-key-raw-ws-like-2002` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/2003` | `key-raw-ws-like-2003` | `ser-key-raw-ws-like-2003` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/2004` | `key-raw-ws-like-2004` | `ser-key-raw-ws-like-2004` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/2005` | `key-raw-ws-like-2005` | `ser-key-raw-ws-like-2005` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/2006` | `key-raw-ws-like-2006` | `ser-key-raw-ws-like-2006` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/2007` | `key-raw-ws-like-2007` | `ser-key-raw-ws-like-2007` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/2008` | `key-raw-ws-like-2008` | `ser-key-raw-ws-like-2008` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/2009` | `key-raw-ws-like-2009` | `ser-key-raw-ws-like-2009` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/200a` | `key-raw-ws-like-200a` | `ser-key-raw-ws-like-200a` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/2028` | `key-raw-ws-like-2028` | `ser-key-raw-ws-like-2028` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/2029` | `key-raw-ws-like-2029` | `ser-key-raw-ws-like-2029` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/202f` | `key-raw-ws-like-202f` | `ser-key-raw-ws-like-202f` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/205f` | `key-raw-ws-like-205f` | `ser-key-raw-ws-like-205f` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/3000` | `key-raw-ws-like-3000` | `ser-key-raw-ws-like-3000` | not applicable, [note 71](#notes) |
| `key/string/raw/ws-like/feff` | `key-raw-ws-like-feff` | `ser-key-raw-ws-like-feff` | not applicable, [note 71](#notes) |
| `key/string/surrogate/adjacent/hh-d800` | `key-surrogate-adjacent-hh-d800` | not applicable, [note 48](#notes) | not applicable, [note 76](#notes) |
| `key/string/surrogate/adjacent/hh-d800-dbff` | `key-surrogate-adjacent-hh-d800-dbff` | not applicable, [note 48](#notes) | not applicable, [note 76](#notes) |
| `key/string/surrogate/adjacent/hh-dbff` | `key-surrogate-adjacent-hh-dbff` | not applicable, [note 48](#notes) | not applicable, [note 76](#notes) |
| `key/string/surrogate/adjacent/lh-dc00-d800` | `key-surrogate-adjacent-lh-dc00-d800` | not applicable, [note 48](#notes) | not applicable, [note 76](#notes) |
| `key/string/surrogate/adjacent/lh-dfff-dbff` | `key-surrogate-adjacent-lh-dfff-dbff` | not applicable, [note 48](#notes) | not applicable, [note 76](#notes) |
| `key/string/surrogate/adjacent/ll-dc00` | `key-surrogate-adjacent-ll-dc00` | not applicable, [note 48](#notes) | not applicable, [note 76](#notes) |
| `key/string/surrogate/adjacent/ll-dfff` | `key-surrogate-adjacent-ll-dfff` | not applicable, [note 48](#notes) | not applicable, [note 76](#notes) |
...
| `key/string/surrogate/lone/raw/d800` | `key-surrogate-lone-raw-d800` | not applicable, [note 50](#notes) | not applicable, [note 89](#notes) |
| `key/string/surrogate/lone/raw/dbff` | `key-surrogate-lone-raw-dbff` | not applicable, [note 50](#notes) | not applicable, [note 89](#notes) |
| `key/string/surrogate/lone/raw/dc00` | `key-surrogate-lone-raw-dc00` | not applicable, [note 50](#notes) | not applicable, [note 89](#notes) |
| `key/string/surrogate/lone/raw/dfff` | `key-surrogate-lone-raw-dfff` | not applicable, [note 50](#notes) | not applicable, [note 89](#notes) |
| `key/string/surrogate/pair/high-corner` | `key-surrogate-pair-high-corner` | not applicable, [note 56](#notes) | not applicable, [note 88](#notes) |
| `key/string/surrogate/pair/interior` | `key-surrogate-pair-interior` | `ser-key-surrogate-pair-interior` | not applicable, [note 88](#notes) |
| `key/string/surrogate/pair/low-corner` | `key-surrogate-pair-low-corner` | not applicable, [note 55](#notes) | not applicable, [note 88](#notes) |
| `key/string/surrogate/pair/mixed` | `key-surrogate-pair-mixed` | not applicable, [note 54](#notes) | not applicable, [note 88](#notes) |
| `leaf/boolean/false` | `false` | `ser-false` | not applicable, [note 79](#notes) |
| `leaf/boolean/true` | `true` | `ser-true` | not applicable, [note 79](#notes) |
| `leaf/nan` | `nan` | `ser-nan` | not applicable, [note 79](#notes) |
| `leaf/null` | `null` | `ser-null` | not applicable, [note 79](#notes) |
| `leaf/undefined` | `undefined` | `ser-undefined` | not applicable, [note 79](#notes) |
| `number/binary` | `number-binary` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/binary-upper` | `number-binary-upper` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/binary-upper/neg` | `number-neg-binary-upper` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
...
| `number/exp/E/neg` | `number-neg-1E2` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/double-sign` | `number-exp-double-sign` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/double-sign/neg` | `number-neg-exp-double-sign` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/e` | `number-1e09` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/e/neg` | `number-neg-1e09` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/high-first` | `number-1e90` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/high-first/neg` | `number-neg-1e90` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/infinity` | `number-exp-word` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/infinity/neg` | `number-neg-exp-word` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/minus` | `number-1e-2` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/minus/neg` | `number-neg-1e-2` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/no-digits` | `number-exp-no-digits` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/no-digits/neg` | `number-neg-exp-no-digits` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/one-digit/high` | `number-1e9` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/one-digit/high/neg` | `number-neg-1e9` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/one-digit/low` | `number-1e0` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/one-digit/low/neg` | `number-neg-1e0` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/plus` | `number-1e+2` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/plus/neg` | `number-neg-1e+2` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/point` | `number-exp-point` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/point/neg` | `number-neg-exp-point` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/sign/no-digits` | `number-exp-sign-no-digits` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
| `number/exp/sign/no-digits/neg` | `number-neg-exp-sign-no-digits` | not applicable, [note 6](#notes) | not applicable, [note 72](#notes) |
...
| `number/frac/one-digit` | `number-1.0` | not applicable, [note 8](#notes) | not applicable, [note 85](#notes) |
| `number/frac/one-digit/high` | `number-1.9` | not applicable, [note 8](#notes) | not applicable, [note 85](#notes) |
| `number/frac/one-digit/high/neg` | `number-neg-1.9` | not applicable, [note 8](#notes) | not applicable, [note 85](#notes) |
| `number/frac/one-digit/neg` | `number-neg-1.0` | not applicable, [note 8](#notes) | not applicable, [note 85](#notes) |
| `number/hex` | `number-hex` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
...
| `number/leading-point` | `number-leading-point` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/leading-point/neg` | `number-neg-leading-point` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/leading-zero` | `number-leading-zero` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/leading-zero/neg` | `number-neg-leading-zero` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/leading-zeros` | `number-leading-zeros` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/leading-zeros/neg` | `number-neg-leading-zeros` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/notation/exp/high` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-number-1e21` |
| `number/notation/exp/high/neg` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-number-neg-1e21` |
| `number/notation/exp/low` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-number-1e-7` |
| `number/notation/exp/low/mantissa` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-number-exp-low-mantissa` |
| `number/notation/exp/low/mantissa/neg` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-number-exp-low-mantissa-neg` |
| `number/notation/exp/low/neg` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-number-neg-1e-7` |
| `number/notation/fixed/high` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-number-1e20` |
| `number/notation/fixed/high/neg` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-number-neg-1e20` |
| `number/notation/fixed/low` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-number-1e-6` |
| `number/notation/fixed/low/neg` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-number-neg-1e-6` |
| `number/octal` | `number-octal` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/octal-upper` | `number-octal-upper` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/octal-upper/neg` | `number-neg-octal-upper` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/octal/neg` | `number-neg-octal` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/plus` | `number-plus` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/plus/zero` | `number-plus-zero` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/separator` | `number-separator` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/separator/neg` | `number-neg-separator` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/shortest/frac` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-number-shortest-frac` |
| `number/shortest/frac/neg` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-number-neg-shortest-frac` |
| `number/shortest/int` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-number-shortest-int` |
| `number/shortest/int/neg` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-number-neg-shortest-int` |
| `number/trailing-point` | `number-trailing-point` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/trailing-point/neg` | `number-neg-trailing-point` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `number/zero/exp` | `number-0e0` | not applicable, [note 7](#notes) | not applicable, [note 80](#notes) |
| `number/zero/exp/neg` | `number-neg-0e0` | not applicable, [note 7](#notes) | not applicable, [note 80](#notes) |
| `number/zero/frac` | `number-0.0` | not applicable, [note 7](#notes) | not applicable, [note 80](#notes) |
| `number/zero/frac/neg` | `number-neg-0.0` | not applicable, [note 7](#notes) | not applicable, [note 80](#notes) |
| `object/double-comma` | `object-double-comma` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `object/duplicate/adjacent` | `object-duplicate-first` | not applicable, [note 24](#notes) | not applicable, [note 73](#notes) |
| `object/duplicate/both-levels` | `object-duplicate-both-levels` | not applicable, [note 24](#notes) | not applicable, [note 73](#notes) |
| `object/duplicate/escaped` | `object-duplicate-escaped` | not applicable, [note 24](#notes) | not applicable, [note 73](#notes) |
| `object/duplicate/escaped-first` | `object-duplicate-escaped-first` | not applicable, [note 24](#notes) | not applicable, [note 73](#notes) |
| `object/duplicate/index` | `object-duplicate-index` | not applicable, [note 24](#notes) | not applicable, [note 73](#notes) |
| `object/duplicate/nested` | `object-duplicate-nested` | not applicable, [note 24](#notes) | not applicable, [note 73](#notes) |
...
| `object/key-order/non-index/hex` | `object-key-order-non-index-hex` | not applicable, [note 25](#notes) | not applicable, [note 75](#notes) |
| `object/key-order/non-index/negative` | `object-key-order-non-index-negative` | not applicable, [note 25](#notes) | not applicable, [note 75](#notes) |
| `object/key-order/non-index/negative-zero` | `object-key-order-non-index-negative-zero` | not applicable, [note 25](#notes) | not applicable, [note 75](#notes) |
...
| `reference/member` | `reference-member` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `reference/prefix` | `reference-prefix` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `reference/self` | `reference-self` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `reference/unbound` | `reference-unbound` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `reference/unbound/among` | `reference-unbound-among` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/continuation` | `string-continuation` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/continuation/crlf` | `string-continuation-crlf` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/empty` | `string-empty` | `ser-string-empty` | `norm-string-empty` |
| `string/escape/0` | `string-escape-0` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
...
| `string/escape/backtick` | `string-escape-backtick` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/escape/f` | `string-escape-f` | `ser-string-escape-f` | `norm-string-escape-f` |
| `string/escape/identity` | `string-escape-identity` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/escape/identity/a` | `string-escape-identity-a` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/escape/n` | `string-escape-n` | `ser-string-escape-n` | `norm-string-escape-n` |
| `string/escape/octal` | `string-escape-octal` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/escape/octal/8` | `string-escape-octal-8` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
...
| `string/escape/u/09af` | `string-escape-u-09af` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/9afA` | `string-escape-u-9afA` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/AF09` | `string-escape-u-AF09` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/F09a` | `string-escape-u-F09a` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/afAF` | `string-escape-u-afAF` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/fAF0` | `string-escape-u-fAF0` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/002f/0` | `string-escape-u-non-hex-002f-0` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/002f/1` | `string-escape-u-non-hex-002f-1` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/002f/2` | `string-escape-u-non-hex-002f-2` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/002f/3` | `string-escape-u-non-hex-002f-3` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/003a/0` | `string-escape-u-non-hex-003a-0` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/003a/1` | `string-escape-u-non-hex-003a-1` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/003a/2` | `string-escape-u-non-hex-003a-2` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/003a/3` | `string-escape-u-non-hex-003a-3` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0040/0` | `string-escape-u-non-hex-0040-0` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0040/1` | `string-escape-u-non-hex-0040-1` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0040/2` | `string-escape-u-non-hex-0040-2` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0040/3` | `string-escape-u-non-hex-0040-3` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0047/0` | `string-escape-u-non-hex-0047-0` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0047/1` | `string-escape-u-non-hex-0047-1` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0047/2` | `string-escape-u-non-hex-0047-2` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0047/3` | `string-escape-u-non-hex-0047-3` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0060/0` | `string-escape-u-non-hex-0060-0` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0060/1` | `string-escape-u-non-hex-0060-1` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0060/2` | `string-escape-u-non-hex-0060-2` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0060/3` | `string-escape-u-non-hex-0060-3` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0067/0` | `string-escape-u-non-hex-0067-0` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0067/1` | `string-escape-u-non-hex-0067-1` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0067/2` | `string-escape-u-non-hex-0067-2` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/non-hex/0067/3` | `string-escape-u-non-hex-0067-3` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/short/0` | `string-escape-u-short-0` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u/short/3` | `string-escape-u-short-3` | not applicable, [note 18](#notes) | not applicable, [note 77](#notes) |
| `string/escape/u00/0000` | `string-escape-u00-0000` | `ser-string-escape-u00-0000` | `norm-string-escape-u00-0000` |
| `string/escape/u00/0007` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-string-escape-u00-0007` |
| `string/escape/u00/000b` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-string-escape-u00-000b` |
| `string/escape/u00/000e` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-string-escape-u00-000e` |
| `string/escape/u00/000f` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-string-escape-u00-000f` |
| `string/escape/u00/0010` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-string-escape-u00-0010` |
| `string/escape/u00/0019` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-string-escape-u00-0019` |
| `string/escape/u00/001a` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-string-escape-u00-001a` |
| `string/escape/u00/001f` | `string-escape-u00-001f` | `ser-string-escape-u00-001f` | `norm-string-escape-u00-001f` |
| `string/escape/uppercase` | `string-escape-uppercase-n` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/escape/uppercase/u` | `string-escape-uppercase-u` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/escape/v` | `string-escape-v` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/escape/x` | `string-escape-x` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/mixed` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-string-mixed` |
| `string/quote/single` | `string-quote-single` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/quote/template` | `string-quote-template` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/quote/template/empty` | `string-quote-template-empty` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/raw-control/0000` | `string-raw-0000` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/raw-control/0009` | `string-raw-0009` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/raw-control/000a` | `string-raw-000a` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `string/raw-control/000d` | `string-raw-000d` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
...
| `string/raw/range/0023-005b/high` | `string-raw-005b` | not applicable, [note 57](#notes) | `norm-string-raw-005b` |
| `string/raw/range/0023-005b/low` | `string-raw-0023` | not applicable, [note 57](#notes) | `norm-string-raw-0023` |
| `string/raw/range/005d-10ffff/high` | `string-raw-10ffff` | `ser-string-raw-10ffff` | `norm-string-raw-10ffff` |
| `string/raw/range/005d-10ffff/low` | `string-raw-005d` | not applicable, [note 61](#notes) | `norm-string-raw-005d` |
| `string/raw/slash` | `string-raw-slash` | not applicable, [note 22](#notes) | `norm-string-raw-slash` |
| `string/raw/surrogate-hole/d7ff` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-string-raw-d7ff` |
| `string/raw/surrogate-hole/e000` | not applicable, [note 65](#notes) | not applicable, [note 66](#notes) | `norm-string-raw-e000` |
| `string/raw/ws-like/00a0` | `string-raw-ws-like-00a0` | `ser-string-raw-ws-like-00a0` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/1680` | `string-raw-ws-like-1680` | `ser-string-raw-ws-like-1680` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/2000` | `string-raw-ws-like-2000` | `ser-string-raw-ws-like-2000` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/2001` | `string-raw-ws-like-2001` | `ser-string-raw-ws-like-2001` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/2002` | `string-raw-ws-like-2002` | `ser-string-raw-ws-like-2002` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/2003` | `string-raw-ws-like-2003` | `ser-string-raw-ws-like-2003` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/2004` | `string-raw-ws-like-2004` | `ser-string-raw-ws-like-2004` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/2005` | `string-raw-ws-like-2005` | `ser-string-raw-ws-like-2005` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/2006` | `string-raw-ws-like-2006` | `ser-string-raw-ws-like-2006` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/2007` | `string-raw-ws-like-2007` | `ser-string-raw-ws-like-2007` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/2008` | `string-raw-ws-like-2008` | `ser-string-raw-ws-like-2008` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/2009` | `string-raw-ws-like-2009` | `ser-string-raw-ws-like-2009` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/200a` | `string-raw-ws-like-200a` | `ser-string-raw-ws-like-200a` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/2028` | `string-raw-ws-like-2028` | `ser-string-raw-ws-like-2028` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/2029` | `string-raw-ws-like-2029` | `ser-string-raw-ws-like-2029` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/202f` | `string-raw-ws-like-202f` | `ser-string-raw-ws-like-202f` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/205f` | `string-raw-ws-like-205f` | `ser-string-raw-ws-like-205f` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/3000` | `string-raw-ws-like-3000` | `ser-string-raw-ws-like-3000` | not applicable, [note 70](#notes) |
| `string/raw/ws-like/feff` | `string-raw-ws-like-feff` | `ser-string-raw-ws-like-feff` | not applicable, [note 70](#notes) |
| `string/surrogate/adjacent/hh-d800` | `string-surrogate-adjacent-hh-d800` | not applicable, [note 47](#notes) | not applicable, [note 74](#notes) |
| `string/surrogate/adjacent/hh-d800-dbff` | `string-surrogate-adjacent-hh-d800-dbff` | not applicable, [note 47](#notes) | not applicable, [note 74](#notes) |
| `string/surrogate/adjacent/hh-dbff` | `string-surrogate-adjacent-hh-dbff` | not applicable, [note 47](#notes) | not applicable, [note 74](#notes) |
| `string/surrogate/adjacent/lh-dc00-d800` | `string-surrogate-adjacent-lh-dc00-d800` | not applicable, [note 47](#notes) | not applicable, [note 74](#notes) |
| `string/surrogate/adjacent/lh-dfff-dbff` | `string-surrogate-adjacent-lh-dfff-dbff` | not applicable, [note 47](#notes) | not applicable, [note 74](#notes) |
| `string/surrogate/adjacent/ll-dc00` | `string-surrogate-adjacent-ll-dc00` | not applicable, [note 47](#notes) | not applicable, [note 74](#notes) |
| `string/surrogate/adjacent/ll-dfff` | `string-surrogate-adjacent-ll-dfff` | not applicable, [note 47](#notes) | not applicable, [note 74](#notes) |
...
| `string/surrogate/lone/raw/d800` | `string-surrogate-lone-raw-d800` | not applicable, [note 49](#notes) | not applicable, [note 87](#notes) |
| `string/surrogate/lone/raw/dbff` | `string-surrogate-lone-raw-dbff` | not applicable, [note 49](#notes) | not applicable, [note 87](#notes) |
| `string/surrogate/lone/raw/dc00` | `string-surrogate-lone-raw-dc00` | not applicable, [note 49](#notes) | not applicable, [note 87](#notes) |
| `string/surrogate/lone/raw/dfff` | `string-surrogate-lone-raw-dfff` | not applicable, [note 49](#notes) | not applicable, [note 87](#notes) |
| `string/surrogate/pair/high-corner` | `string-surrogate-pair-high-corner` | not applicable, [note 53](#notes) | not applicable, [note 86](#notes) |
| `string/surrogate/pair/interior` | `string-surrogate-pair-interior` | `ser-string-surrogate-pair-interior` | not applicable, [note 86](#notes) |
| `string/surrogate/pair/low-corner` | `string-surrogate-pair-low-corner` | not applicable, [note 52](#notes) | not applicable, [note 86](#notes) |
| `string/surrogate/pair/mixed` | `string-surrogate-pair-mixed` | not applicable, [note 51](#notes) | not applicable, [note 86](#notes) |
| `value/expression/binary` | `value-binary` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/expression/call` | `value-call` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/expression/comma` | `value-comma` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/expression/double-negation` | `value-double-negation` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/expression/index` | `value-index` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/expression/new` | `value-new` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/expression/parenthesized` | `value-parenthesized` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/expression/ternary` | `value-ternary` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/expression/this` | `value-this` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/expression/typeof` | `value-typeof` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/expression/void` | `value-void` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/sign/array` | `value-sign-array` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/sign/bare` | `value-sign-bare` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/sign/double` | `value-sign-double` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/sign/nan` | `value-sign-nan` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/sign/null` | `value-sign-null` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/sign/plus-infinity` | `value-sign-plus-infinity` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/sign/reference` | `value-sign-reference` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/sign/space` | `value-sign-space` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/sign/string` | `value-sign-string` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/sign/true` | `value-sign-true` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `value/sign/undefined` | `value-sign-undefined` | not applicable, [note 1](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/000b` | `ws-other-000b` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/000c` | `ws-other-000c` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/000c/leading` | `ws-other-000c-leading` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/00a0` | `ws-other-00a0` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/00a0/container` | `ws-other-00a0-container` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/1680` | `ws-other-1680` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/2000` | `ws-other-2000` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/2001` | `ws-other-2001` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/2002` | `ws-other-2002` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/2003` | `ws-other-2003` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/2004` | `ws-other-2004` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/2005` | `ws-other-2005` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/2006` | `ws-other-2006` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/2007` | `ws-other-2007` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/2008` | `ws-other-2008` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/2009` | `ws-other-2009` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/200a` | `ws-other-200a` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/2028` | `ws-other-2028` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/2028/required` | `ws-other-2028-required` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/2029` | `ws-other-2029` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/202f` | `ws-other-202f` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/205f` | `ws-other-205f` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/3000` | `ws-other-3000` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/3000/trailing` | `ws-other-3000-trailing` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/feff` | `ws-other-feff` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/other/feff/first` | `ws-other-feff-first` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/required/const` | `ws-required-const` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
...
| `whitespace/required/default/infinity` | `ws-required-default-infinity` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `whitespace/required/default/name` | `ws-required-default-name` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
...
| `whitespace/required/default/negative-infinity` | `ws-required-default-negative-infinity` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
...
| `whitespace/required/export` | `ws-required-export` | not applicable, [note 4](#notes) | not applicable, [note 67](#notes) |
| `ws/around-colon` | `ws-around-colon` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/around-comma` | `ws-around-comma` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/before-semicolon` | `ws-before-semicolon` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/cr/everywhere` | `ws-cr-everywhere` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/cr/required` | `ws-cr-required` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/cr/run` | `ws-cr-run` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/crlf` | `ws-crlf` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/inside-empty` | `ws-inside-empty` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/lf/everywhere` | `ws-lf-everywhere` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/lf/required` | `ws-lf-required` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/lf/run` | `ws-lf-run` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/none-optional` | `ws-none-optional` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/run/all-four` | `ws-run-all-four` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/run/all-four/reversed` | `ws-run-all-four-reversed` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/space/everywhere` | `ws-space-everywhere` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/space/required` | `ws-space-required` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/space/run` | `ws-space-run` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/tab/everywhere` | `ws-tab-everywhere` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/tab/required` | `ws-tab-required` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
| `ws/tab/run` | `ws-tab-run` | not applicable, [note 3](#notes) | not applicable, [note 69](#notes) |
=======
...
>>>>>>> claude/datajs-serializer-accept-vectors
...
<<<<<<< HEAD
65. **`reader`**, set `normalize` — normalized form is one serializer's output rule, so a class only that set carries names a spelling and not a document a reader must take
66. **`serializer`**, set `normalize` — an ordinary serializer owes a valid document denoting the input and never a spelling, so a class only the normalize set carries is outside what this role is judged on
67. **`normalize`**, set `reject` — a reject class names a document a reader refuses, and normalized form emits only documents, so it has no output for one
68. **`normalize`**, subtree `id` — this is a fact about a document a reader takes, and normalized form is handed a graph, so the class has no normalized output of its own
69. **`normalize`**, subtree `ws` — this is a fact about a document a reader takes, and normalized form is handed a graph, so the class has no normalized output of its own
70. **`normalize`**, subtree `string/raw/ws-like` — normalized form leaves every raw character unescaped, which the raw vectors pin at both ends of that branch; these differ only in which scalar they are, and the escaping rule does not branch on that
71. **`normalize`**, subtree `key/string/raw/ws-like` — normalized form leaves every raw character unescaped, which the raw vectors pin at both ends of that branch; these differ only in which scalar they are, and the escaping rule does not branch on that
72. **`normalize`**, subtree `number/exp` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
73. **`normalize`**, subtree `object/duplicate` — this is a fact about a document a reader takes, and normalized form is handed a graph, so the class has no normalized output of its own
74. **`normalize`**, subtree `string/surrogate/adjacent` — the four lone surrogates and the pair are pinned, and the escaping rule is per code unit, so an adjacency's spelling follows from theirs with nothing left to decide
75. **`normalize`**, subtree `object/key-order/non-index` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
76. **`normalize`**, subtree `key/string/surrogate/adjacent` — the four lone surrogates and the pair are pinned, and the escaping rule is per code unit, so an adjacency's spelling follows from theirs with nothing left to decide
77. **`normalize`**, subtree `string/escape/u` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
78. **`normalize`**, subtree `key/string/escape/u` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
79. **`normalize`**, subtree `leaf` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
80. **`normalize`**, subtree `number/zero` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
81. **`normalize`**, subtree `array/nested` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
82. **`normalize`**, subtree `object/nested` — the bytes are pinned by the vector that carries this value under its own class; the shape here varies only in a count or a depth, which normalized layout does not branch on
83. **`normalize`**, subtree `const/reference` — this is a fact about a document a reader takes, and normalized form is handed a graph, so the class has no normalized output of its own
84. **`normalize`**, subtree `document/trailing` — this is a fact about a document a reader takes, and normalized form is handed a graph, so the class has no normalized output of its own
85. **`normalize`**, subtree `number/frac/one-digit` — normalized form emits one spelling per value, and this class is another spelling the reader takes for a value the set already pins
86. **`normalize`**, subtree `string/surrogate/pair` — the four lone surrogates and the pair are pinned, and the escaping rule is per code unit, so an adjacency's spelling follows from theirs with nothing left to decide
87. **`normalize`**, subtree `string/surrogate/lone/raw` — the four lone surrogates and the pair are pinned, and the escaping rule is per code unit, so an adjacency's spelling follows from theirs with nothing left to decide
88. **`normalize`**, subtree `key/string/surrogate/pair` — the four lone surrogates and the pair are pinned, and the escaping rule is per code unit, so an adjacency's spelling follows from theirs with nothing left to decide
