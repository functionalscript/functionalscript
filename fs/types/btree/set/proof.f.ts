...
const test = [
    () => {
        ...
        assert(r === '[[["1","100"],"16",["25","36"]],"4",[["49"],"64",["81","9"]]]', r)
    },
    ...
    () => {
        ...
        for (let i = 2; i <= 11; i++)
            _map = set(_map)((i * i).toString())
        const r = jsonStr(_map)
        assert(r === '[[["1"],"100",["121"],"16",["25","36"]],"4",[["49"],"64",["81","9"]]]', r)
    },
    ...
    () => {
        ...
        for (let i = 2; i <= 12; i++)
            _map = set(_map)((i * i).toString())
        const r = jsonStr(_map)
        assert(r === '[[["1"],"100",["121","144"],"16",["25","36"]],"4",[["49"],"64",["81","9"]]]', r)
    },
    ...
    () => {
        ...
        for (let i = 2; i <= 13; i++)
            _map = set(_map)((i * i).toString())
        const r = jsonStr(_map)
        assert(r === '[[["1"],"100",["121","144"]],"16",[["169"],"25",["36"]],"4",[["49"],"64",["81","9"]]]', r)
    },
    ...
    () => {
        ...
        for (let i = 2; i <= 14; i++)
            _map = set(_map)((i * i).toString())
        const r = jsonStr(_map)
        assert(r === '[[["1"],"100",["121","144"]],"16",[["169","196"],"25",["36"]],"4",[["49"],"64",["81","9"]]]', r)
    },
    ...
    () => {
        ...
        for (let i = 2; i <= 15; i++)
            _map = set(_map)((i * i).toString())
        const r = jsonStr(_map)
        assert(r === '[[["1"],"100",["121","144"]],"16",[["169"],"196",["225"],"25",["36"]],"4",[["49"],"64",["81","9"]]]', r)
    },
    ...
    () => {
        ...
        for (let i = 2; i <= 16; i++)
            _map = set(_map)((i * i).toString())
        const r = jsonStr(_map)
        assert(r === '[[["1"],"100",["121","144"]],"16",[["169"],"196",["225"],"25",["256","36"]],"4",[["49"],"64",["81","9"]]]', r)
    },
    ...
    () => {
        ...
        for (let i = 2; i <= 17; i++)
            _map = set(_map)((i * i).toString())
        const r = jsonStr(_map)
        assert(r === '[[[["1"],"100",["121","144"]],"16",[["169"],"196",["225"]]],"25",[[["256"],"289",["36"]],"4",[["49"],"64",["81","9"]]]]', r)
    },
