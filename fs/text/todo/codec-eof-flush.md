...
`fs/text/utf16/module.f.ts:234-235`:
...
`code_point.decoder` factory (`fs/text/code_point/module.f.ts:33-41`, i168)
...
Add a companion to `decoder` in `fs/text/code_point/module.f.ts`:
...
- [ ] Add `eofFlush` to `fs/text/code_point/module.f.ts` beside `decoder`.
