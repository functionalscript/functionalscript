...
pub mod method_map;
pub mod method_pad_end;
pub mod method_pad_start;
...
pub mod method_trim;
pub mod method_trim_end;
pub mod method_trim_start;
pub mod method_with;
pub mod mul;
pub mod ne;
pub mod neg;
...
pub fn all<A: IStaticFunction>() {
    ...
    method_substring::run::<A>();
    method_repeat::run::<A>();
    method_pad_start::run::<A>();
    method_pad_end::run::<A>();
    method_trim::run::<A>();
