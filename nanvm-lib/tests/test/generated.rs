...
fn eq<A: IVm>() {
    ...
    check::<A>("nanByNan", strict_eq((f64::NAN).to_any(), (f64::NAN).to_any()), false.to_any());
    check::<A>("nanByNanSwapped", strict_eq((f64::NAN).to_any(), (f64::NAN).to_any()), false.to_any());
    check::<A>("zeroByNegativeZero", strict_eq((0f64).to_any(), (-0f64).to_any()), true.to_any());
    check::<A>("zeroByNegativeZeroSwapped", strict_eq((-0f64).to_any(), (0f64).to_any()), true.to_any());
    check::<A>("infinityByInfinity", strict_eq((f64::INFINITY).to_any(), (f64::INFINITY).to_any()), true.to_any());
    check::<A>("infinityByInfinitySwapped", strict_eq((f64::INFINITY).to_any(), (f64::INFINITY).to_any()), true.to_any());
    check::<A>("negativeInfinityByNegativeInfinity", strict_eq((f64::NEG_INFINITY).to_any(), (f64::NEG_INFINITY).to_any()), true.to_any());
    check::<A>("negativeInfinityByNegativeInfinitySwapped", strict_eq((f64::NEG_INFINITY).to_any(), (f64::NEG_INFINITY).to_any()), true.to_any());
    check::<A>("infinityByNegativeInfinity", strict_eq((f64::INFINITY).to_any(), (f64::NEG_INFINITY).to_any()), false.to_any());
    check::<A>("infinityByNegativeInfinitySwapped", strict_eq((f64::NEG_INFINITY).to_any(), (f64::INFINITY).to_any()), false.to_any());
    check::<A>("undefinedByNan", strict_eq(Nullish::Undefined.to_any(), (f64::NAN).to_any()), false.to_any());
    check::<A>("undefinedByNanSwapped", strict_eq((f64::NAN).to_any(), Nullish::Undefined.to_any()), false.to_any());
...
fn pow<A: IVm>() {
    ...
    check::<A>("halfToThePowerOfInfinity", Any::pow((f64::from_bits(0x3fe0000000000000)).to_any(), (f64::INFINITY).to_any()), (0f64).to_any());
    check::<A>("twoToThePowerOfNegativeInfinity", Any::pow((2f64).to_any(), (f64::NEG_INFINITY).to_any()), (0f64).to_any());
    check::<A>("halfToThePowerOfNegativeInfinity", Any::pow((f64::from_bits(0x3fe0000000000000)).to_any(), (f64::NEG_INFINITY).to_any()), (f64::INFINITY).to_any());
    ...
    check::<A>("negativeTwoToThePowerOfHalf", Any::pow((-2f64).to_any(), (f64::from_bits(0x3fe0000000000000)).to_any()), (f64::NAN).to_any());
