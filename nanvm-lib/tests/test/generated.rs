...
fn eq<A: IVm>() {
    ...
    check::<A>("numberBySameNumber", strict_eq((2.3f64).to_any(), (2.3f64).to_any()), true.to_any());
    check::<A>("numberBySameNumberSwapped", strict_eq((2.3f64).to_any(), (2.3f64).to_any()), true.to_any());
    check::<A>("numberByOtherNumber", strict_eq((2.3f64).to_any(), (-5.4f64).to_any()), false.to_any());
    check::<A>("numberByOtherNumberSwapped", strict_eq((-5.4f64).to_any(), (2.3f64).to_any()), false.to_any());
