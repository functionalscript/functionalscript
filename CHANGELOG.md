...
- Implementation-only JSDoc typedefs in the migrated `fjs/types/array` and
  `fjs/types/bit_vec` modules are renamed to their private `_`-prefixed forms.
  Public declarations keep the same expanded types
