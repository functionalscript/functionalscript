...
import { classic } from './testlib.f.ts'
...
const classicTest = () => {
    ...
    return {
        ws: eq(x.ws, '{"empty":true,"map":[[false,8],[true,10],[false,12],[true,13],[false,31],[true,32]]}'),
        sign: eq(x.sign, '{"empty":true,"map":[[false,42],[true,43],[false,44],[true,45]]}'),
        digits: eq(x.digits, '{"empty":false,"map":[[false,47],[true,57]]}'),
        exponent: eq(x.exponent, '{"empty":true,"map":[[false,68],[true,69],[false,100],[true,101]]}'),
        fraction: eq(x.fraction, '{"empty":true,"map":[[false,45],[true,46]]}'),
        onenine: eq(x.onenine, '{"empty":false,"map":[[false,48],[true,57]]}'),
        digit: eq(x.digit, '{"empty":false,"map":[[false,47],[true,57]]}'),
        string: eq(x.string, '{"empty":false,"map":[[false,33],[true,34]]}'),
        member: eq(x.member, '{"empty":false,"map":[[false,8],[true,10],[false,12],[true,13],[false,31],[true,32],[false,33],[true,34]]}'),
        members: eq(x.members, '{"empty":false,"map":[[false,8],[true,10],[false,12],[true,13],[false,31],[true,32],[false,33],[true,34]]}'),
        object: eq(x.object, '{"empty":false,"map":[[false,122],[true,123]]}'),
        array: eq(x.array, '{"empty":false,"map":[[false,90],[true,91]]}'),
        integer: eq(x.integer, '{"empty":false,"map":[[false,44],[true,45],[false,47],[true,57]]}'),
        number: eq(x.number, '{"empty":false,"map":[[false,44],[true,45],[false,47],[true,57]]}'),
        value: eq(x.value, '{"empty":false,"map":[[false,33],[true,34],[false,44],[true,45],[false,47],[true,57],[false,90],[true,91],[false,101],[true,102],[false,109],[true,110],[false,115],[true,116],[false,122],[true,123]]}'),
        element: eq(
            x.element,
        ...
        json: eq(
            x.json,
            '{"empty":false,"map":[[false,8],[true,10],[false,12],[true,13],[false,31],[true,32],[false,33],[true,34],[false,44],[true,45],[false,47],[true,57],[false,90],[true,91],[false,101],[true,102],[false,109],[true,110],[false,115],[true,116],[false,122],[true,123]]}'),
        hex: eq(x.hex, '{"empty":false,"map":[[false,47],[true,57],[false,64],[true,70],[false,96],[true,102]]}'),
        escape: eq(x.escape, '{"empty":false,"map":[[false,33],[true,34],[false,46],[true,47],[false,91],[true,92],[false,97],[true,98],[false,101],[true,102],[false,109],[true,110],[false,113],[true,114],[false,115],[true,117]]}'),
        character: eq(x.character, '{"empty":false,"map":[[false,31],[true,33],[false,34],[true,1114111]]}'),
        characters: eq(x.characters, '{"empty":true,"map":[[false,31],[true,33],[false,34],[true,1114111]]}'),
    }
}
