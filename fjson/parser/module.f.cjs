...
/** @type {(state: StateParse) => (value: json.Unknown) => FjsonState} */
...
/** @type {(token: tokenizer.FjsonToken) => json.Unknown} */
...
/** @type {(tokenList: list.List<tokenizer.FjsonToken>) => result.Result<json.Unknown, string>} */
