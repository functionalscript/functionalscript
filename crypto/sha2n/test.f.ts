...
export default {
    ...
    s512x224: () => {
        const result = f64(base64.compressV16(sha512x224)(empty64)) >> 288n
        const x = 0x6ed0dd02806fa89e25de060c19d3ac86cabb87d6a0ddd05c333b84f4n
        if(result !== x) { throw [result, x] }
    },
    s512x256: () => {
        const result = f64(base64.compressV16(sha512x256)(empty64)) >> 256n
