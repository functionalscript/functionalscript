...
export default {
    ...
    sha2: {
        sha256: () => checkEmpty(sha256)(0x1_e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855n),
        sha224: () => checkEmpty(sha224)(0x1_d14a028c2a3a2bc9476102bb288234c415a2b01f828ea62ac5b3e42fn),
        sha512: () => checkEmpty(sha512)(0x1_cf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36ce9ce47d0d13c5d85f2b0ff8318d2877eec2f63b931bd47417a81a538327af927da3en),
        sha384: () => checkEmpty(sha384)(0x1_38b060a751ac96384cd9327eb1b1e36a21fdb71114be07434c0cc7bf63f6e1da274edebfe76f65fbd51ad2f14898b95bn),
        sha512x256: () => checkEmpty(sha512x256)(0x1_c672b8d1ef56ed28ab87c3622c5114069bdd3ad7b8f9737498d0c01ecef0967an),
        sha512x224: () => checkEmpty(sha512x224)(0x1_6ed0dd02806fa89e25de060c19d3ac86cabb87d6a0ddd05c333b84f4n),
    },
    utf8: [
        () => {
        ...
        () => {
            const s = msbUtf8("The quick brown fox jumps over the lazy dog.")
            const h = computeSync(sha224)([s])
            if (h !== 0x1_619cba8e8e05826e9b8c519c0a5c68f4fb653e8a3d8aa04bb2c8cd4cn) { throw h }
        },
        () => {
            const s = msbUtf8("hello world")
            if (s !== 0x1_68656C6C_6F20776F_726C64n) { throw s }
            let state = sha256.init
            state = sha256.append(state)(s)
            const h = sha256.end(state)
            if (h !== 0x1_b94d27b9_934d3e08_a52e52d7_da7dabfa_c484efe3_7a5380ee_9088f7ac_e2efcde9n) { throw h }
        }
    ],
    fill: () => {
        ...
        return {
            ...
            16: () => {
                ...
                state = sha256.append(state)(r)
                const h = sha256.end(state)
                if (h !== 0x1_3138bb9b_c78df27c_473ecfd1_410f7bd4_5ebac1f5_9cf3ff9c_fe4db77a_ab7aedd3n) { throw h }
            }
        }
    }
}
