    ...
    switch (i[0]) {
        case 0: {
            ...
            if (n.length === 3) {
                ...
                if (a.length === 1) {
                    switch (n2.length) {
                        case 3: { return [[a[0], v1, ...n2], v3, n4] }
                        case 5: { return [[a[0], v1, n2[0]], n2[1], [n2[2], n2[3], n2[4]], v3, n4] }
                        default: { throw 'invalid node' }
                    }
                } else {
                    return [a, v1, n2, v3, n4]
                }
            }
        }
        case 2: {
            ...
            if (n.length === 3) {
                ...
                if (a.length === 1) {
                    switch (n0.length) {
                        case 3: { return [[...n0, v1, a[0]], v3, n4] }
                        case 5: { return [[n0[0], n0[1], n0[2]], n0[3], [n0[4], v1, a[0]], v3, n4] }
                        default: { throw 'invalid node' }
                    }
                } else {
                    return [n0, v1, a, v3, n4]
                }
            }
        }
        case 4: {
            const [n0, v1, n2, v3, ] = i[1]
            if (a.length === 1) {
                switch (n2.length) {
                    case 3: { return [n0, v1, [...n2, v1, a[0]]] }
                    case 5: { return [n0, v1, [n2[0], n2[1], n2[2]], n2[3], [n2[4], v1, a[0]]] }
                    default: { throw 'invalid node' }
                }
            } else {
                return [n0, v1, n2, v3, a]
            }
        }
    }
}
