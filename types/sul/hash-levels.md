...
2. a bit vector (more is better). In theory, we can use only #2 and #3 but it means that we will need to call a hash function for really short sequences, about 16 bits.
