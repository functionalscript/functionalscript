...
- Reference issues from [./issues/README.md](./issues/README.md) with the `i` prefix (e.g. `i135`), not GitHub's `#` prefix. `#NNN` is reserved for GitHub PR/issue numbers; `iNNN` refers to entries in `issues/README.md`.
