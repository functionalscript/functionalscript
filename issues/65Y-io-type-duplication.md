...
fs/emergent_testing/module.ts         : `io`, `runProgram` — same Node bootstrap
...
- `fs/fjs/module.ts`, `fs/emergent_testing/module.ts` — the two live bootstraps
