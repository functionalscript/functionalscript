...
- The plain `fromCharCode` re-binding has three consumers (`html`, `fsc`,
  ...
  name in module after module" smell that i167 flags for
...
- i167 — re-binding a shared helper under per-module names.
- i168 — the utf8/utf16 *decoder* skeleton (a different, list-level
