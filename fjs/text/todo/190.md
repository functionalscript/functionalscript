...
```ts
// fjs/text/ascii/module.f.mjs:11
const r = s.codePointAt(i)
if (r === void 0) { throw s }

// fjs/text/utf16/module.f.mjs:267
const first = s.charCodeAt(i)
return isNaN(first) ? empty : { first, tail: () => at(i + 1) }
```

A concrete casualty of the missing primitive: `fjs/text/sgr/module.f.mjs:20`
re-declares the backspace control character as a string literal
(`export const backspace: string = '\x08'`) even though
`fjs/text/ascii/module.f.mjs:30` already owns the code
(`export const backspace = one('\b')`) — `sgr` cannot say
