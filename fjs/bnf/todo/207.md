...
O(actioned rules) once, and resolve names at construction. What to do with a
rule `subset` cannot prove is the open question in §5.3; this Decision does not
settle it. Recognize repetition by **structural right-recursion analysis**
