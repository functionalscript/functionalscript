...
export const proof = {
    ...
    leaves: {
        primitives: () => {
            ...
            // it away over a numeric literal: `-0` is the number `-0`, so
            // every reader of the graph sees the leaf it saw before there
            // was an operator, and the Rust printer keeps its text for one
