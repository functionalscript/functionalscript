 ...
 * case — a numeric literal negated is the number — so the graph holds the
 * leaf, and everything else reaches it as a node whose value `run` works
 * out for the document outputs.
 */
