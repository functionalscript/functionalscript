...
`fjs/protocol/mcp/cas/evo/module.f.ts`, `fjs/cas/module.f.ts`, `fjs/protocol/mcp/cas/module.f.ts`,
...
`fjs/protocol/mcp/cas/module.f.ts`, `fjs/protocol/mcp/module.f.ts`, `fjs/protocol/mcp/stdio/module.f.ts`,
...
- [ ] `fjs/cas` + `fjs/cas/evo` + `fjs/protocol/mcp/cas/evo` + `fjs/protocol/mcp/cas`.
