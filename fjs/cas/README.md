...
- [fjs/protocol/mcp/cas](../protocol/mcp/cas/) — an MCP front end for agents, including read-time
...
declared on write. [fjs/media](../media/) does that recovery: byte-signature
sniffing (PNG/JPEG/GIF/WebP/PDF/ZIP, `fjs/media/type`) plus, for JSON blobs
