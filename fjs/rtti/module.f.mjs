 ...
 * @import { Tag0, Primitive0, _Type0, Bigint, Unknown, Option, Tag1, _MakeType1, _MakeOpen, _MakeRest, Or, Type } from './types.ts'
 */
...
export const tag0List = /** @type {const} */ ([...primitive0List, 'unknown', 'option'])
