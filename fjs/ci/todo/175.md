...
- It is **complementary to, not a duplicate of, [i170](./170.md)/i171**.
...
- [i170](./170.md), i171 — the `toolSteps` step-sequence
  builder; this factory feeds it.
- i136, [i138](./138.md) — tool-version lock file; the pinned
