## 65Z-ci-nix-hardening. Add comprehensive validation and fixed artifact hashes
...
- generating `flake.lock` files — covered by [Phase 6](65z-ci-nix-locks.md).
...
- [Phase 6 — Nix input locks](65z-ci-nix-locks.md).
