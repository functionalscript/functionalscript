## ci-nix-locks. Generate and commit Nix input lock files
...
hashes belong to [Phase 7](ci-nix-hardening.md).
...
- [Phase 7 — validation and fixed artifact hashes](ci-nix-hardening.md).
