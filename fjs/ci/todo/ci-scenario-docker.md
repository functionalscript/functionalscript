## ci-scenario-docker. Build and use Nix-based OCI images for Linux CI

**Priority:** P3
**Status:** blocked
**Phase:** 4
**Blocked by:** [Phase 3 — direct Nix CI](ci-nix-ci.md)
...
- [Phase 6](ci-nix-locks.md), which commits Nix input locks;
...
- [Phase 5 — macOS Nix caching](ci-nix-cache-macos.md).
- [Phase 7 — validation and fixed hashes](ci-nix-hardening.md).
