## 66B-dockerfile-nix-integration. Dependency-driven Nix CI and OCI rollout
...
**Task:** [65Z-ci-nix-ci](65z-ci-nix-ci.md)
...
**Task:** [65Z-ci-scenario-docker](65z-ci-scenario-docker.md)
**Depends on:** Phase 3
...
**Task:** [65Z-ci-nix-cache-macos](65z-ci-nix-cache-macos.md)
**Depends on:** Phase 3
...
**Task:** [65Z-ci-nix-locks](65z-ci-nix-locks.md)
**Depends on:** Phase 2
...
**Task:** [65Z-ci-nix-hardening](65z-ci-nix-hardening.md)
**Depends on:** Phase 2
...
- [65Z-ci-nix](65z-ci-nix.md) — Phase 2 generation.
- [65Z-ci-nix-ci](65z-ci-nix-ci.md) — Phase 3 direct CI.
- [65Z-ci-scenario-docker](65z-ci-scenario-docker.md) — Phase 4 Linux OCI.
- [65Z-ci-nix-cache-macos](65z-ci-nix-cache-macos.md) — Phase 5 macOS cache.
- [65Z-ci-nix-locks](65z-ci-nix-locks.md) — Phase 6 locks.
- [65Z-ci-nix-hardening](65z-ci-nix-hardening.md) — Phase 7 validation and hashes.
