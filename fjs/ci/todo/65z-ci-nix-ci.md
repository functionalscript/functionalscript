## 65Z-ci-nix-ci. Run Linux and macOS CI through generated Nix environments
...
- [Phase 6](65z-ci-nix-locks.md), which commits `flake.lock` files;
...
- [Phase 4 — build and use Linux OCI images](65z-ci-scenario-docker.md).
- [Phase 5 — investigate GitHub caching for macOS Nix environments](65z-ci-nix-cache-macos.md).
