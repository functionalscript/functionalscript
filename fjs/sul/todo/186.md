...
```js
// fjs/crypto/sha2/module.f.mjs:239
/** @type {(a: V8) => bigint} */
...
This removes `vecX20`, `ltv` (one of the [i167](../../types/bit_vec/module.f.mjs) `listToVec(msb)`
...
- [i167](../../types/bit_vec/module.f.mjs) — `listToVec(msb)` re-binding
  (`ltv` here is one instance); shipped as the shared `msb.listToVec`.
