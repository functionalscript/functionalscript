...
`fjs/common/monoid/module.f.mjs:84-98`). Monoid `repeat` cannot serve here
...
Add a generic combinator to `fjs/types/function/module.f.mjs`:
...
- `fjs/common/monoid/module.f.mjs:84-98` — `repeat`, the logarithmic
