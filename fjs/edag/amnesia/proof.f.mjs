...
export const proof = {
    ...
    // JavaScript.
    count: () => {
        const f = /** @type {(...a: unknown[]) => unknown} */ (vm(context)(['=>', 2, ['[]', []], ['args']]))
        assertEq(f.length, 2)
        assertStructurallySame(f(1), [1])
        assertStructurallySame(f(1, undefined), [1, undefined])
        assertStructurallySame(f(1, 2, 3), [1, 2, 3])
        eq(['.', ['=>', 2, ['[]', []], ['args']], 'length'], 2)
