...
export const proof = {
    ...
    functions: {
        ...
        otherFrame: () => {
            ...
            // `-0` included, and ahead of the `function_any` shortcut, which
            // `===` would have let it through
            assertEq(refusalReason(['=>', -0, ['[]', []], ['undefined']])[0], 'no Rust for a parameter count that is no nonnegative integer')
