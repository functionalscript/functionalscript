...
[rtti data form](../rtti/todo/data-form.md). Revisit then, designing the skeleton as a
...
- [rtti data form](../rtti/todo/data-form.md) — RTTI data form; the likely third consumer.
