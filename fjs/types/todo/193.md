...
- i179 (retired; shipped as [`collapseRoot`](../btree/types/module.f.mjs), shared by
  `btree/set` and `btree/map`) — the single-child root collapse (the tail of both
  functions).
- i164 — uncurrying these same `fold` accumulators; complementary
