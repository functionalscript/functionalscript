...
```ts
// fjs/types/rtti/common/module.f.mjs:99
...
```ts
// fjs/types/rtti/ts/module.f.mjs:118
...
- `fjs/types/rtti/common/module.f.mjs:99,124` — `visitConst` / `visit`, the
  shared schema walker.
- `fjs/types/rtti/ts/module.f.mjs:118-145` — the printer's duplicated
