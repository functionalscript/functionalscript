...
types are in [`types.ts`](./types.ts). What remains of the codec is two
issues: the byte path, in
[`todo/parser-serializer.md`](./todo/parser-serializer.md), and the
serializer with normalized form, in
