...
- `media/djs/` — mimeType `text/javascript`, dialect `vnd.fjs.djs+vnd.fjs.fjs`.
  Overtaken: the format became [`media/datajs/`](../media/datajs/README.md) and
  the front end [`fsc/`](../fsc/README.md), and `fjs/djs/` is gone.
...
- [x] Later: move `fjs/djs/` → `fjs/media/djs/` — overtaken; `fjs/djs/` is gone,
      see above.
