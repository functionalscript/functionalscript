...
| [generic-parser-metadata](../bnf/todo/generic-parser-metadata.md), [043-stateful-parser](../bnf/todo/043-stateful-parser.md) | keep | the classical backend's metadata protocol; for `ebnf/` it is superseded by [meta-ast-mapping](../ebnf/todo/meta-ast-mapping.md), which each of them cites at its head |
