...
published; widening that glob is the other half, and belongs to that issue.
...
`../AGENTS.md` §2 names `private.ts` alongside `types.ts`.
...
- [ ] Restore it in the 16 `private.ts` files.
...
- [`../website/todo/publish-deno-doc-to-website.md`](../website/todo/publish-deno-doc-to-website.md)
  — the other half: its `**/module.f.mjs` glob would have to widen before any of
  this reaches a reader.
