...
**Status:** blocked
**Blocked by:**
- The `fjs/ebnf/terminal/` module, which carries the terminal domain and
  the integer helpers over `fjs/types/range_set` values
...
- [ebnf-range-set](../../terminal/todo/ebnf-range-set.md) — the
