...
- [`emergent_testing/todo/share-browser-console-runner.md`](../../emergent_testing/todo/share-browser-console-runner.md) — existing migration plan for the separate `emergent_testing/browser.mjs` violation.
