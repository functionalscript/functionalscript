...
fixtures showed the cost: `function` and `rest-function` were committed
"@generated by `fjs compile`", but neither was compiled by `gen` nor included
by `src/lib.rs`, so they were neither drift-checked nor built.
