...
// and a function nested deeper captures through its parent, even alongside a
// module `const` of its own.
...
/** @type {(...a: readonly number[]) => (...b: readonly number[]) => number} */
const both = (...a) => (...b) => a[0] + b[0] + base[0];
export default [add(1)(2), offset(5), three(1)(2)(3), both(20)(12)];
