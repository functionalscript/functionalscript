...
pub fn module<A: IStaticFunction>() -> Result<Any<A>, Any<A>> {
    ...
    Ok([(string_key("default"), [(Any::call(c0.clone(), [f64_any(0x3ff0000000000000)].to_array().to_any()))?, (Any::call(c0.clone(), [f64_any(0x4000000000000000)].to_array().to_any()))?].to_array().to_any())].to_object().to_any())
}
