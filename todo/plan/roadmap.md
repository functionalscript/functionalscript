...
**Layer 1 — Base (done)**
- `cas_add`, `cas_get`, `cas_list` implemented in `fjs/protocol/mcp/cas/module.f.ts` ✓
...
|---|---|---|
| 1. Base MCP (add/get/list) | `fjs/protocol/mcp/cas/`, `fjs/protocol/mcp/stdio/`, CLI ✓ | `casMcpStep` extraction |
