...
- [fjs/media/json/extended](../../fjs/media/json/extended/module.f.mjs) — a built, JSON-compatible instance of the same underlying idea, scoped to one codec rather than the full language.
